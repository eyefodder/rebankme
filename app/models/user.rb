...
class User < ActiveRecord::Base
  ...
  ZIPS = '10001 10002 10003 10004 10005 10006 10007 10009 10010 ' \
         ...
         '10039 10040 10044 10128 10280 10301 10302 10303 10304 ' \
         ...
         '10470 10471 10472 10473 10474 10475 11004 11005 11101 ' \
         '11102 11103 11104 11105 11106 11201 11203 11204 11205 ' \
         '11206 11207 11208 11209 11210 11211 11212 11213 11214 ' \
         '11215 11216 11217 11218 11219 11220 11221 11222 11223 ' \
         '11224 11225 11226 11228 11229 11230 11231 11232 11233 ' \
         '11234 11235 11236 11237 11238 11239 11354 11355 11356 ' \
         ...
         '11427 11428 11429 11432 11433 11434 11435 11436 11691 ' \
  ...
  def set_option(key, value)
    ...
    if value == 'false'
      option = assoc_class.FALSE_VALUE
    else
      option = assoc_class.find_by(name_id: value)
    end
    send(set_assoc_method, option)
  end

  def special_group?
    return if special_group.nil?
